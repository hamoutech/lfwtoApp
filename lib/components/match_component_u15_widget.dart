...
import 'match_component_u15_model.dart';
export 'match_component_u15_model.dart';

class MatchComponentU15Widget extends StatefulWidget {
  const MatchComponentU15Widget({
    super.key,
  ...
  @override
  State<MatchComponentU15Widget> createState() =>
      _MatchComponentU15WidgetState();
}

class _MatchComponentU15WidgetState extends State<MatchComponentU15Widget> {
  late MatchComponentU15Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MatchComponentU15Model());
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        matchInfoContainerMatchRecord.matchInfosU15.journee,
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily: 'Bebas Neue',
                      ...
                      Text(
                        matchInfoContainerMatchRecord.matchInfosU15.stade,
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily: 'Bebas Neue',
                              color: const Color(0xA7050000),
                              fontSize: 6.0,
                      ...
                      Text(
                        matchInfoContainerMatchRecord.matchInfosU15.heure,
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily: 'Bebas Neue',
                              color: const Color(0xA7050000),
                              fontSize: 6.0,
