...
import 'match_component_u17_model.dart';
export 'match_component_u17_model.dart';

class MatchComponentU17Widget extends StatefulWidget {
  const MatchComponentU17Widget({
    super.key,
  ...
  @override
  State<MatchComponentU17Widget> createState() =>
      _MatchComponentU17WidgetState();
}

class _MatchComponentU17WidgetState extends State<MatchComponentU17Widget> {
  late MatchComponentU17Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MatchComponentU17Model());
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        matchInfoContainerMatchRecord.matchInfosU17.journee,
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily: 'Bebas Neue',
                      ...
                      Text(
                        matchInfoContainerMatchRecord.matchInfosU17.stade,
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily: 'Bebas Neue',
                              color: const Color(0xA7050000),
                              fontSize: 6.0,
                      ...
                      Text(
                        matchInfoContainerMatchRecord.matchInfosU17.heure,
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily: 'Bebas Neue',
                              color: const Color(0xA7050000),
                              fontSize: 6.0,
