...
import 'match_component_u13_model.dart';
export 'match_component_u13_model.dart';

class MatchComponentU13Widget extends StatefulWidget {
  const MatchComponentU13Widget({
    super.key,
  ...
  @override
  State<MatchComponentU13Widget> createState() =>
      _MatchComponentU13WidgetState();
}

class _MatchComponentU13WidgetState extends State<MatchComponentU13Widget> {
  late MatchComponentU13Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MatchComponentU13Model());
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        matchInfoContainerMatchRecord.matchInfosU13.journee,
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily: 'Bebas Neue',
                      ...
                      Text(
                        matchInfoContainerMatchRecord.matchInfosU13.stade,
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily: 'Bebas Neue',
                              color: const Color(0xA7050000),
                              fontSize: 6.0,
                      ...
                      Text(
                        matchInfoContainerMatchRecord.matchInfosU13.heure,
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily: 'Bebas Neue',
                              color: const Color(0xA7050000),
                              fontSize: 6.0,
