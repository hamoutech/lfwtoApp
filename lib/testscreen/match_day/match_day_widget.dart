...
export 'match_day_model.dart';

class MatchDayWidget extends StatefulWidget {
  const MatchDayWidget({super.key});

  @override
  State<MatchDayWidget> createState() => _MatchDayWidgetState();
}

class _MatchDayWidgetState extends State<MatchDayWidget> {
  late MatchDayModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MatchDayModel());
